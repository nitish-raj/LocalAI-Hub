...
docker compose -f compose.yaml -f docker-compose.gpu.yaml pull

echo "Removing old containers..."
docker compose -f compose.yaml -f docker-compose.gpu.yaml down

echo "Starting up with new images (with GPU support)..."
